 ...
 * @version 1.0
 */
public class NeuralNetworkOptimizationProblemFmeas implements HillClimbingProblem, GeneticAlgorithmProblem {
     ...
     */
    public NeuralNetworkOptimizationProblemFmeas(DataSet examples,
             NeuralNetwork network, ErrorMeasure measure) {
        eval = new NeuralNetworkEvaluationFunctionFmeas(network, examples, measure);
